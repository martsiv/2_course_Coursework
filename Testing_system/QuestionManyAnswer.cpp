...
QuestionManyAnswer::QuestionManyAnswer(string description, vector<string>& answers, vector<int>& numbersOfRightAnswer)
...
bool QuestionManyAnswer::isCorrectRightAnswer()
{
	for (auto i : numbersOfRightAnswer)
	{
...
float QuestionManyAnswer::CheckAnswer()
{
...
void QuestionManyAnswer::ShowRightAnswer()
{
	if (!isCorrectRightAnswer())
	{
		cout << "Erorr question! Check questin or answer!\n";
...
void QuestionManyAnswer::ChangeAnswer()
{
	vector<string> tmp;
	string userAnswer;
	char ch;
...
void QuestionManyAnswer::ChangeRightAnswer()
{
	int count = 0;
...
void QuestionManyAnswer::ShowAllAnswers()
{
	int count = 1;
	for (auto i : answers)
		cout << count++ << ") " << i << endl;
}
void QuestionManyAnswer::Export(string filename)
{
